...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [auth_service_1.AuthService, auth_functions_service_1.AuthFunctionsService],
        controllers: [auth_controller_1.AuthController],
        exports: [auth_service_1.AuthService, auth_functions_service_1.AuthFunctionsService],
    })
], AuthModule);
